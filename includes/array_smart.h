...
namespace seq
{
	...
	private:
		pointer	first_{};	/* ”казатель на первый элемент */
		pointer	last_{};	/* ”казатель на элемент следующий за последним */
		pointer	end_{};		/* ”казатель на адрес пам€ти следующий за последним выделенным */
	};
}
